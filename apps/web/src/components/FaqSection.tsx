...
const faqs = [
  ['無料とPlusの違いは？', '無料プランでは猫プロフィール2匹、在庫10件まで登録できます。Plusは月額300円、年額3,000円で、登録数の上限がなくなり、広告が非表示になります。家族共有、購入履歴、月別費用レポート、複数端末同期は無料のまま使える予定です。'],
  ...
  ['いつリリース予定ですか？', '現在開発中です。公開時期が決まり次第、このWebサイトでお知らせします。']
];
