...
const sections = [
  {
    title: '1. 適用',
    body: [
      'この利用規約（以下「本規約」といいます。）は、にゃんストック運営（以下「運営者」といいます。）が提供するペット用品の在庫管理・買い忘れ防止アプリ「にゃんストック」（以下「本アプリ」といいます。）の利用条件を定めるものです。',
  ...
  },
  {
    title: '2. サービス内容',
    body: [
      '本アプリは、フード、トイレ用品、おやつ、サプリメント等のペット用品の在庫、残り日数、購入履歴、商品リンク、通知設定等の管理を補助するサービスです。',
    ],
  },
  {
    title: '3. アカウント・共有同期',
