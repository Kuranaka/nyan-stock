-- Run this in Supabase SQL Editor to enable normalized household sync.
-- TODO before release: replace anon policies with authenticated household membership policies.
...
create policy "Anon households read" on public.households for select using (true);
drop policy if exists "Anon households create" on public.households;
create policy "Anon households create" on public.households for insert with check (true);
drop policy if exists "Anon households update" on public.households;
create policy "Anon households update" on public.households for update using (true) with check (true);

drop policy if exists "Anon household cats read" on public.household_cats;
create policy "Anon household cats read" on public.household_cats for select using (true);
drop policy if exists "Anon household cats create" on public.household_cats;
create policy "Anon household cats create" on public.household_cats for insert with check (true);
drop policy if exists "Anon household cats update" on public.household_cats;
create policy "Anon household cats update" on public.household_cats for update using (true) with check (true);
drop policy if exists "Anon household cats delete" on public.household_cats;
create policy "Anon household cats delete" on public.household_cats for delete using (true);

drop policy if exists "Anon household inventory read" on public.household_inventory_items;
create policy "Anon household inventory read" on public.household_inventory_items for select using (true);
drop policy if exists "Anon household inventory create" on public.household_inventory_items;
create policy "Anon household inventory create" on public.household_inventory_items for insert with check (true);
drop policy if exists "Anon household inventory update" on public.household_inventory_items;
create policy "Anon household inventory update" on public.household_inventory_items for update using (true) with check (true);
drop policy if exists "Anon household inventory delete" on public.household_inventory_items;
create policy "Anon household inventory delete" on public.household_inventory_items for delete using (true);

drop policy if exists "Anon household purchase history read" on public.household_purchase_history;
create policy "Anon household purchase history read" on public.household_purchase_history for select using (true);
drop policy if exists "Anon household purchase history create" on public.household_purchase_history;
create policy "Anon household purchase history create" on public.household_purchase_history for insert with check (true);
drop policy if exists "Anon household purchase history update" on public.household_purchase_history;
create policy "Anon household purchase history update" on public.household_purchase_history for update using (true) with check (true);
drop policy if exists "Anon household purchase history delete" on public.household_purchase_history;
create policy "Anon household purchase history delete" on public.household_purchase_history for delete using (true);
