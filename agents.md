...
- Configure and verify Supabase Auth providers for release, especially Apple Sign in with Apple settings, redirect URLs, Apple Developer identifiers/keys, and iOS bundle ID alignment.
